 ...
 *
 * Mirror of backend/utils/phone.js. Duplicated rather than shared because the
 * three codebases have no common module path — if you change the rules here,
 * change them in all three. The backend copy is authoritative: it normalises
 * on save, so a client that gets this wrong produces a bad link, not bad data.
 *
